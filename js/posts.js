...
const POSTS = [
  {
    ...
    title: "비밀의정원 운영 원칙을 다시 세우다 — 인건비, 영업시간, 그리고 9월의 전환",
    excerpt: "오프라인 칵테일바 운영의 기본 구조를 숫자로 못 박았다. 고정 인건비 상한, 9월부터의 성과 연동, 주 6일 영업 루틴. 결정은 기록해야 지켜진다.",
    date: "2026. 8. 22.",
    tags: ["비밀의정원", "운영", "결정"],
    content: `
...
**2. 9월부터 급여를 순이익의 10%로 전환**
고정 급여 구조에서 성과 연동 구조로 바꾼다. 가게가 잘 되면 같이 잘 되고, 어려우면 같이 버티는 구조. 9월 1일 시행 — 그날 다시 점검한다.
...
- **9월 1일**: 급여 구조 전환 시행 — 인건비 600만 이하가 지켜지고 있는지 확인
