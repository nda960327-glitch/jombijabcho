...
const PROJECTS = [
  ...
  },
  {
    ...
    start: "운영 중",
    goal: "인건비 월 600만 이하 유지 → 9/1 급여 순이익 연동 전환",
    metrics: [
    ...
    next: [
      "가게 문제점 정리 → 개선 방향 도출",
      "9/1 급여 구조 전환 준비 (순이익 계산 기준 정하기)",
      "월 매출/방문 수 기록 시작하기"
    ],
    log: [
      { date: "2026.08.22", text: "운영 원칙 확정: 인건비 상한(월 600만), 9/1부터 급여 순이익 연동 전환, 영업 화~일 18:30~02:30, 사장 출근 시간 고정." },
      { date: "2026.08.22", text: "좀비잡초 트래킹 보드에 등록." }
    ]
  },
  {
